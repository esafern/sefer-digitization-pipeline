...
24. **REVIEWED 2026-08-26 (user-requested): the words that exist in Yad Malachi
    ...
    **Not done:** the 384 remain unread, and the dictionary cannot settle them -
    it is silent on prefixed forms by construction. They need a human or a vision
    pass; frequency alone demonstrably gets them wrong (see `רבואתא`, `בישרץ`).
