...
def main():
    ...
    # Filter regions for Part 1 (klal_id <= 222)
    part1_items = []
    ...
    print("=" * 80)
    print(f"RUNNING VLM FULL BASELINE OCR FOR PART 1 ({len(part1_items)} REGION CROPS / 222 KLALIM)")
    print("=" * 80)
    ...
    for i, reg in enumerate(part1_items, 1):
        ...
        print(f"[{i}/{len(part1_items)}] Transcribing Klal {klal_id:3d} (Page {page_num:2d})...", end="", flush=True)
