...
# (regenerated by pipeline/build_gematria_trace.py since 2026-08-17 -
# this comment used to name a `trace_gematria_sequence.py` that exists
# nowhere in the repo, from the era when the trace file's generator was
# genuinely lost) and docai_word_boxes/ page tokens. Parts 2-3 now have
# traces of their own but no span-coverage baseline, so this still runs
# Part 1 only.
import os
import sys
